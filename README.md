...
<p style="text-align: center"><a href="https://github.com/admpub/go-captcha">Go Captcha</a> is a behavior security CAPTCHA, which implements text click verification, slide verification and rotation verification.</p>
...
- Go Example：[https://github.com/admpub/go-captcha-example](https://github.com/admpub/go-captcha-example)
- Go Assets File：[https://github.com/admpub/go-captcha-assets](https://github.com/admpub/go-captcha-assets)
...
func init() {
	...
	// You can use preset material resources：https://github.com/admpub/go-captcha-assets
